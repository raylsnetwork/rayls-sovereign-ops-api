...
CONTRACTS_DIR="../rayls-sovereign-contracts"
PLAYGROUND_DIR="../rayls-privacy-playground"
CUSTODY_DIR="../rayls-sovereign-custody-light"
BLOCKSCOUT_DIR="../rayls-privacy-blockscout"
RELAYER_DIR="../rayls-sovereign-relayer"
RAYUP_DIR="../rayup"
...
teardown_everything() {
    ...
    docker_rm_matching ps -aq --filter 'name=rayls-sovereign-ops-api' --filter 'name=rayup' \
        --filter 'name=shared-'

    for net in blockscout-shared rayup_default rayls-sovereign-ops-api_default \
    ...
    docker_rmi_matching '^(rayls-sovereign-ops-api|rayup)([-_].*)?:'
    ...
    for vol in $(docker volume ls --format '{{.Name}}' 2>/dev/null \
                 | grep -E '^(rayls-sovereign-ops-api|rayup)[-_]'); do
