...
1. Open the [Security tab](https://github.com/raylsnetwork/rayls-sovereign-ops-api/security) of this repository.
...
- The affected component(s) (`ops-api` / `worker` / `custody` integration), version(s), and configuration.
...
This policy covers the `rayls-sovereign-ops-api` repository (the ops-service API and worker).
