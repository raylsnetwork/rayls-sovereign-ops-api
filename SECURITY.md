...
1. Open the [Security tab](https://github.com/raylsnetwork/rayls-privacy-ops-api/security) of this repository.
...
This policy covers the `rayls-privacy-ops-api` repository (the ops-service API and worker).
